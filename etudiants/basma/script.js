...
document.addEventListener('DOMContentLoaded',function(){
  ...
  fetch('etudiants.json')
    ...
    .then(function(data){
      // Logo sur l'écran de connexion = photo de l'étudiant si dispo
      if(data[0]&&data[0].photo_b64){
        document.getElementById('login-photo').src='data:image/jpeg;base64,'+data[0].photo_b64;
      }
